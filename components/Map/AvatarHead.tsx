    ...
    >
      <div className="cursor-pointer hover:scale-110 transition-transform">
        <div
          ...
          style={isSelf ? {
            boxShadow: '0 0 0 2.5px #3b82f6, 0 0 12px 4px rgba(59, 130, 246, 0.5)',
          } : isFriend ? {
            boxShadow: '0 0 0 2.5px #22c55e, 0 0 12px 4px rgba(34, 197, 94, 0.5)',
          } : {
            boxShadow: '0 0 0 2.5px white, 0 4px 6px -1px rgba(0,0,0,0.4)',
          }}
        >
          {profile?.avatar_url ? (
            <img
